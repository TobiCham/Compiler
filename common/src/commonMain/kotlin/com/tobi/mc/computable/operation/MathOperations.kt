...
class Add(arg1: Computable, arg2: Computable) : MathOperation(arg1, arg2, "+", Long::plus)
class Subtract(arg1: Computable, arg2: Computable) : MathOperation(arg1, arg2, "-", Long::minus)
class Multiply(arg1: Computable, arg2: Computable) : MathOperation(arg1, arg2, "*", Long::times)
class Divide(arg1: Computable, arg2: Computable) : MathOperation(arg1, arg2, "/", { v1, v2 ->
    if(v2 == 0L) throw ScriptException("Divide by 0")
    v1 / v2
})
